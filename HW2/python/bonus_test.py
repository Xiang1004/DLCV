...
if __name__ == '__main__':
    ...
    parser.add_argument('--img_path', type=str, default='data/digits/usps/test')
    parser.add_argument('--save_path', type=str, default='checkpoint/pred2.csv')
    parser.add_argument('--ckp_path1', type=str, default='model/p4_1.pth')
    parser.add_argument('--ckp_path2', type=str, default='model/p4_2.pth')
    parser.add_argument('--ckp_path3', type=str, default='model/p4_3.pth')
